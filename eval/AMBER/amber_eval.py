...
def get_args():
    ...
    parser.add_argument("--word_association", type=str, default='/path/to/your/workdir/AFTER/eval/AMBER/relation.json')
    parser.add_argument("--safe_words", type=str, default='/path/to/your/workdir/AFTER/eval/AMBER/safe_words.txt')
    # parser.add_argument("--inference_data", type=str)
    parser.add_argument("--annotation", type=str, default='/path/to/your/workdir/AFTER/eval/AMBER/annotations.json')
    parser.add_argument("--metrics", type=str, default='/path/to/your/workdir/AFTER/eval/AMBER/metrics.txt')
...
def main(args):
    ...
    if args.dimensions[0] == 'all':
        # args.dimensions = ['gen', 'dis-attribute_sub', 'dis-existence_sub', 'dis-relation_sub']
        args.dimensions = ['dis_sub']
    for dim in args.dimensions:
        ...
        datapath = os.path.join(args.data_dir, args.validate_dataset, f'{args.model}_{dim}{args.subfix}.jsonl')
...
if __name__ == "__main__":
    ...
    args.dimensions = 'gen' #['gen']
    args.device = '1'
    args.model = 'shikra_7B'
    args.validate_dataset = 'AMBER' #[AMBER]
    args.subfix = ''
